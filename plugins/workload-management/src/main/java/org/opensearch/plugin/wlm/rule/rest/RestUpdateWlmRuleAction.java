...
public class RestUpdateWlmRuleAction extends RestUpdateRuleAction {
    ...
    protected <T extends ActionType<? extends UpdateRuleResponse>> T retriveUpdateRuleActionInstance() {
    ...
    @Override
    protected UpdateRuleRequest buildUpdateRuleRequest(String id, String description, Map<Attribute, Set<String>> attributeMap, String featureValue) {
