...
public class WorkloadGroupRuleRoutingService implements RuleRoutingService {
    ...
    public WorkloadGroupRuleRoutingService(
        Client client,
        ...
        transportService.registerRequestHandler(
            CreateRuleAction.NAME + "/" + WorkloadGroupFeatureType.NAME,
    ...
    private void executeLocally(CreateRuleRequest request, ActionListener<CreateRuleResponse> listener) {
        threadPool.executor(RULE_THREAD_POOL_NAME).execute(() -> rulePersistenceService.createRule(request, listener));
    }
}
