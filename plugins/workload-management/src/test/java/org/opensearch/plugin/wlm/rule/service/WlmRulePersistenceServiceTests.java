...
import org.opensearch.plugin.wlm.rule.action.CreateWlmRuleResponse;
...
public class WlmRulePersistenceServiceTests extends OpenSearchTestCase {
    ...
    public void testCreateRule() throws IOException {
        ActionListener<CreateWlmRuleResponse> listener = mock(ActionListener.class);
        ...
        ArgumentCaptor<CreateWlmRuleResponse> responseCaptor = ArgumentCaptor.forClass(CreateWlmRuleResponse.class);
        verify(listener).onResponse(responseCaptor.capture());

        CreateWlmRuleResponse createRuleResponse = responseCaptor.getValue();
