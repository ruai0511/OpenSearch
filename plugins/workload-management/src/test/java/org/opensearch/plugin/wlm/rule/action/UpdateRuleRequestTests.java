...
public class UpdateRuleRequestTests extends OpenSearchTestCase {
    ...
    public void testSerialization() throws IOException {
        UpdateRuleRequest request = new UpdateRuleRequest(_ID_ONE, DESCRIPTION_ONE, ATTRIBUTE_MAP, FEATURE_VALUE_ONE);
    ...
    public void testSerializationWithNull() throws IOException {
        UpdateRuleRequest request = new UpdateRuleRequest(_ID_ONE, null, ATTRIBUTE_MAP, null);
        BytesStreamOutput out = new BytesStreamOutput();
        request.writeTo(out);
        StreamInput streamInput = out.bytes().streamInput();
        UpdateRuleRequest otherRequest = new UpdateRuleRequest(streamInput);
