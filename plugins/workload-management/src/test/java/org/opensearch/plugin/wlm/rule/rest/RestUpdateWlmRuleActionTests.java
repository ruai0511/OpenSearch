...
public class RestUpdateWlmRuleActionTests extends OpenSearchTestCase {
    /**
     * Test case to validate the construction for RestUpdateRuleAction
     */
    public void testConstruction() {
        RestUpdateWlmRuleAction action = new RestUpdateWlmRuleAction();
