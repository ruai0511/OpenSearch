...
public class CreateWlmRuleResponseTests extends OpenSearchTestCase {

    /**
     * Test case to verify serialization and deserialization of CreateRuleResponse
     */
    public void testSerialization() throws IOException {
        CreateWlmRuleResponse response = new CreateWlmRuleResponse(_ID_ONE, ruleOne, RestStatus.OK);
        BytesStreamOutput out = new BytesStreamOutput();
        response.writeTo(out);
        StreamInput streamInput = out.bytes().streamInput();
        CreateWlmRuleResponse otherResponse = new CreateWlmRuleResponse(streamInput);
