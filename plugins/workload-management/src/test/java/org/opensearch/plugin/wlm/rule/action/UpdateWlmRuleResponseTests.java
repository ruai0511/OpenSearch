...
public class UpdateWlmRuleResponseTests extends OpenSearchTestCase {

    /**
     * Test case to verify serialization and deserialization of UpdateRuleResponse
     */
    public void testSerialization() throws IOException {
        UpdateWlmRuleResponse response = new UpdateWlmRuleResponse(_ID_ONE, ruleOne, RestStatus.OK);
        BytesStreamOutput out = new BytesStreamOutput();
        response.writeTo(out);
        StreamInput streamInput = out.bytes().streamInput();
        UpdateWlmRuleResponse otherResponse = new UpdateWlmRuleResponse(streamInput);
